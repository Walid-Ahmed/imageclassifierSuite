...
'''
code copied from https://github.com/titu1994/Keras-DualPathNetworks
...
def DualPathNetwork(input_shape=None,
                    ...
                    input_tensor=None,
                    pooling=None,
                    classes=1000,finalActivation="softmax"):
    ...
    x = _create_dpn(classes, img_input, include_top, initial_conv_filters,
                    filter_increment, depth, cardinality, width, weight_decay, pooling,finalActivation)
...
def DPN92(input_shape=None,
    ...
    return DualPathNetwork(input_shape, include_top=include_top, weights=weights, input_tensor=input_tensor,
                           pooling=pooling, classes=classes,finalActivation=finalActivation)
...
def _create_dpn(nb_classes, img_input, include_top, initial_conv_filters,
                filter_increment, depth, cardinality=32, width=3, weight_decay=5e-4, pooling=None,finalActivation="softmax"):
    ...
    if include_top:
        ...
        x = Dense(nb_classes, use_bias=False, kernel_regularizer=l2(weight_decay),
                  kernel_initializer='he_normal', activation=finalActivation)(x)
    else:
        if pooling == 'avg':
